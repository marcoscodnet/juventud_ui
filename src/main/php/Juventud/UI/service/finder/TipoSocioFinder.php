...
class TipoSocioFinder implements  IAutocompleteFinder {
	...
	public function findEntitiesByText( $text, $parent=null ){
		...
		$uiCriteria = new UITipoSocioCriteria();
		$uiCriteria->setTipo( $text );
		$uiCriteria->setRowPerPage( 10 );
		return UIServiceFactory::getUITipoSocioService()->getList($uiCriteria);	
	}
	...
	function findEntityByCode( $code, $parent=null ){
		...
		return UIServiceFactory::getUITipoSocioService()->get( $code );
	}
