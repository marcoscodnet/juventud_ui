...
class SocioFinder implements  IAutocompleteFinder {
	...
	public function findEntitiesByText( $text, $parent=null ){
		...
		$uiCriteria->setApellido( $text );
		$uiCriteria->setRowPerPage( 10 );
		return UIServiceFactory::getUISocioService()->getList($uiCriteria);	
	}
	...
	function findEntityByCode( $code, $parent=null ){
		...
		return UIServiceFactory::getUISocioService()->get( $code );
	}
	...
	public function getAttributesCallback(){
		return array("oid", "apellido","nombre");		
	}
