<?php
namespace Juventud\UI\pages\usuarios\roles;
 ...
 *
 */
class RolConsultar extends JuventudPage{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$legend = JuventudUIUtils::formatMessage($legend, array($this->getUsuario()->getName()));
