...
namespace Juventud\UI\components\form\usuario;

use Juventud\UI\components\filter\model\UIUsuarioCriteria;

use Juventud\UI\service\finder\UsuarioFinder;
...
use Juventud\Core\model\Usuario;
...
class UsuarioForm extends Form{
	...
	public function fillEntity($entity){
		...
		$entity->setUsername( strtolower( $entity->getUsername() ) );
