...
namespace Juventud\UI\components\form\rol;

use Juventud\UI\components\filter\model\UIRolCriteria;
use Juventud\UI\components\filter\model\UIPermisoCriteria;

use Juventud\UI\service\finder\RolFinder;
...
class RolPermisosForm extends Form{
	...
	protected function parseXTemplate(XTemplate $xtpl){
		...
		$legend = JuventudUIUtils::formatMessage($legend, array($this->getRol()->getName()));
